...
function PageHeader($$renderer, $$props) {
  ...
  $$renderer.push(`<header class="mb-8"><div class="flex flex-wrap items-start justify-between gap-4"><div><h1 class="text-3xl font-bold tracking-tight">${escape_html(title)}</h1> `);
  if (subtitle) {
    $$renderer.push("<!--[-->");
    $$renderer.push(`<p class="mt-1 text-gray-400">${escape_html(subtitle)}</p>`);
  } else {
    $$renderer.push("<!--[!-->");
  }
  $$renderer.push(`<!--]--></div> `);
